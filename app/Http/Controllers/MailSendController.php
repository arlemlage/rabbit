    ...
    public static function sendMailToUsers($mail_data){
        ...
        if (!empty($mail_data) && !empty($mail_data['to']) && !empty($mail_data['view'])){
            ...
            try
            {
                ...
                $mail->Body = view('all-mail-templates.'.$mail_data['view'], ['mail_data' => $mail_data])->render();
                $mail->send();
            }
            catch (Exception $e) {
                ...
                foreach($mail_data['to'] as $email) {
                    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                        $sendSmtpEmail = new \SendinBlue\Client\Model\SendSmtpEmail([
                            ...
                            'htmlContent' => view('all-mail-templates.'.$mail_data['view'], ['mail_data' => $mail_data])->render(),
