    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #e3f1fc; padding: 20px">
        <tr>
            ...
            ">
                    ...
                    line-height: 1.5;
                  ">
                                Dear {!! !empty($mail_data['customer_info']->getFullNameAttribute())
                                    ? $mail_data['customer_info']->getFullNameAttribute()
                                    : '' !!},
                            </p>
                            <p style="margin: 20px 0 0 0; font-size: 16px; line-height: 1.5">
                                We need to know what you think of our customer service. Please take a moment
                                to answer one simple question
                                by clicking the bellow link.
                            </p>
                            <p style="margin: 20px 0 0 0; font-size: 16px; line-height: 1.5">
                            ...
                            <div style="margin: 30px 0 0px; text-align: center">
                                <a href="{{ url($mail_data['ticket_view_feedback']) }}"
                                    style="
                    ...
                    ">Submit
                            ...
                            <div style="margin: 30px 0 0px; text-align: center">
                                <a href="{{ url($mail_data['ticket_view_url']) }}"
                                    style="
                      background-color: #4e73df;
                      color: #ffffff;
                      text-decoration: none;
                    ...
                    ">Ticket
                            ...
                            <p style="margin: 20px 0 0 0; font-size: 16px; line-height: 1.5">
                                The message you add to your feedback will not be forwarded as reply. If you
                                would rather talk to your
                                support officer again, you can do that by replying to ticket
                                {{ !empty($mail_data['ticket_info']->ticket_no) ? $mail_data['ticket_info']->ticket_no : '' }}.
                            </p>
                            <p style="margin: 20px 0 0 0; font-size: 16px; line-height: 1.5">
